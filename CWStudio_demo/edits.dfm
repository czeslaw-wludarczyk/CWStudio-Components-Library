  ...
  object scrbEdits: TCWSScrollBox
    ...
    object pnlEdits1: TCWSSettingsPanel
      ...
      object lblTitle1: TLabel
        ...
        Width = 314
        Height = 25
        Caption = 'CWSEdits - with labels and hint text'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -19
        Font.Name = 'Segoe UI'
      ...
      object CWSEdit3: TCWSEdit
        ...
        ButtonIconSize = 14
        OnButtonClick = CWSEdit3ButtonClick
        Text = ''
        LabelText = 'Search'
        CornerRadius = 4.000000000000000000
        TextHint = 'Hint text'
      ...
      object CWSEdit5: TCWSEdit
        ...
        ImageIndex = 0
        Text = ''
        LabelText = 'Custom button icon'
        CornerRadius = 4.000000000000000000
        TabOrder = 4
        TabStop = True
      end
      object CWSEdit11: TCWSEdit
        Left = 608
        Top = 152
        Width = 280
        Height = 47
    ...
    object pnlEdits2: TCWSSettingsPanel
      ...
      object lblTitle2: TLabel
        ...
        Width = 419
        Height = 25
        Caption = 'CWSEdits - without labels and without hint text'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -19
        Font.Name = 'Segoe UI'
    ...
    object pnlEdits3: TCWSSettingsPanel
      ...
      object CWSMemo1: TCWSMemo
        Left = 16
        Top = 63
        Width = 445
        Height = 194
        Text = 
          'CWStudio components feel native on Windows 11.'#13#10#13#10'- The scrollba' +
          'r appears only on hover.'#13#10'- Text rendering uses native VCL '#8212' but' +
          ' the frame is GDI+.'#13#10'- Try resizing the form to see how everythi' +
          'ng reflows.'#13#10#13#10'Add a few more lines so the scrollbar has somethi' +
          'ng to do...'#13#10'Lorem ipsum dolor sit amet, consectetur adipiscing ' +
          'elit.Sed do eiusmod tempor incididunt ut labore et dolore magna ' +
          #13#10'aliqua.'#13#10'Ut enim ad minim veniam, quis nostrud exercitation ul' +
          'lamco.'#13#10'Laboris nisi ut aliquip ex ea commodo consequat.'#13#10
        Lines.Strings = (
          'CWStudio components feel native on Windows 11.'
          ''
          '- The scrollbar appears only on hover.'
          '- Text rendering uses native VCL '#8212' but the frame is GDI+.'
          '- Try resizing the form to see how everything reflows.'
          ''
          'Add a few more lines so the scrollbar has something to do...'
      ...
      object CWSMemo2: TCWSMemo
        ...
        Text = 
          ...
          ' the frame is GDI+.'#13#10'- Try resizing the form to see how everythi' +
          'ng reflows.'#13#10#13#10'Add a few more lines so the scrollbar has somethi' +
          'ng to '#13#10'do...'#13#10'Lorem ipsum dolor sit amet, consectetur adipiscin' +
          'g elit.'#13#10'Sed do eiusmod tempor incididunt ut labore et dolore '#13#10 +
          'magna '#13#10'aliqua.'#13#10'Ut enim ad minim veniam, quis nostrud exercitat' +
          'ion '#13#10'ullamco.'#13#10'Laboris nisi ut aliquip ex ea commodo consequat.' +
          #13#10#13#10
        Lines.Strings = (
          'CWStudio components feel native on Windows 11.'
          ''
          ...
          '- Try resizing the form to see how everything reflows.'
          ''
          'Add a few more lines so the scrollbar has something to '
          'do...'
      ...
      object CWSMemo3: TCWSMemo
        ...
        Text = 
          ...
          'ng reflows.'#13#10#13#10'Add a few more lines so the scrollbar has somethi' +
          'ng to do...'#13#10'Lorem ipsum dolor sit amet, consectetur adipiscing ' +
          'elit.'#13#10'Sed do eiusmod tempor incididunt ut labore et dolore magn' +
          'a '#13#10'aliqua.'#13#10'Ut enim ad minim veniam, quis nostrud exercitation ' +
          'ullamco.'#13#10'Laboris nisi ut aliquip ex ea commodo consequat.'#13#10
        Lines.Strings = (
          'CWStudio components feel native on Windows 11.'
          ''
          '- The scrollbar appears only on hover.'
    ...
    object pnlEdits4: TCWSSettingsPanel
      ...
      object lblTitle4: TLabel
        ...
        Width = 303
        Height = 25
        Caption = 'CWSComboBox + CWSDatepicker'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -19
        Font.Name = 'Segoe UI'
      ...
      object CWSComboBox1: TCWSComboBox
        Left = 16
        Top = 64
        Width = 280
        Height = 29
        ...
        ItemHighlightCornerRadius = 4.000000000000000000
        Items.Strings = (
          'Apple'
          'Banana'
          'Pear'
      ...
      object CWSComboBox2: TCWSComboBox
        Left = 312
        Top = 64
        Width = 280
        Height = 29
      ...
      object CWSComboBox3: TCWSComboBox
        Left = 608
        Top = 64
        Width = 280
        Height = 29
